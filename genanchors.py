'''
adapted from: https://github.com/AlexeyAB/darknet/blob/master/scripts/gen_anchors.py
'''
...
def write_anchors_to_file(centroids,X,anchor_file):
    ...
    for i in range(anchors.shape[0]):
        ...
        anchors[i][0] = int(anchors[i][0]*width_in_cfg_file)
        anchors[i][1] = int(anchors[i][1]*height_in_cfg_file)
